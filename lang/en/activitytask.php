<?php
/**
 * English strings for activitytask
 *
...
$string['activitytask'] = 'Activity Task';
$string['activitytasks'] = 'Activity Tasks';
$string['pluginadministration'] = 'Activity Task Administration';
$string['pluginname'] = 'Activity Task';
$string['activitytaskdone'] = 'An activity task has been completed.';
$string['nostudents'] = 'No enrolled students were found in this class.';
$string['theadstudent'] = 'Student';
...
$string['btn_label_view'] = 'View';
$string['btn_label_done'] = 'Mark Done';
